...
public class Types {
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class SimpleClusterNodeModel implements ParamValidate {
        private Integer cPU;
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class SimpleClusterModel implements ParamValidate {
        private String appVersion;
        ...
        private List<SimpleClusterNodeModel> nodes;

        @JsonProperty(value = "nodes")
        public void setNodes(List<SimpleClusterNodeModel> nodes) {
            this.nodes = nodes;
        }

        @JsonProperty(value = "nodes")
        public List<SimpleClusterNodeModel> getNodes() {
            return this.nodes;
        }
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class AppServiceResourceModel implements ParamValidate {
